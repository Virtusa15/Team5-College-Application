...
public class TestForeignKeyAssociation {
	...
	public static void main(String[] args) {
		Configuration cfg=new Configuration().configure().addAnnotatedClass(Post.class).addAnnotatedClass(PostDetails.class).addAnnotatedClass(EmployeeEntity.class).addAnnotatedClass(AccountEntity.class);
